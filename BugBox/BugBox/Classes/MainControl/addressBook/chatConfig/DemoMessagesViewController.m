...
{
    [super viewDidLoad];
    self.title = self.chatUser.nickName;
    /**
...
- (JSQMessagesAvatarImage*)avatarByClientId:(NSString*)clientId{
    ...
    JSQMessagesAvatarImage *avatar = [JSQMessagesAvatarImageFactory avatarImageWithImage:[UIImage imageNamed:@"coding_emoji_gif_05"] diameter:kJSQMessagesCollectionViewAvatarSizeDefault];
    return avatar;
}
